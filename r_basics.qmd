...
There are many excellent guides for learning and using R & RStudio. An introductory guide is Garrett Grolemund's [Hands-On Programming with R](https://rstudio-education.github.io/hopr/), which I highly recommend for those who are working with R for the first time. I also recommend Hadley Wickham's [R for Data Science](https://r4ds.hadley.nz/) for further topics related to data management and coding workflow strategies. We rely heavily in our textbook on the tidy data principles that Hadley and his colleagues developed.
...
![](AI coding.jpg){fig-align="center" width="350"}
