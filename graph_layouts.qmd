...
Essentially each alrogithm is designed to produce a good layout but each has a specific emphasis of what "good" is. Some seek aesthetically pleasing, or balanced, visualisions while others seek to present the nodes true to the relational structure of the network. Here is a brief summary of how each of these force directed algorithms work and why they generate different network visualisations. Remember, these do not change the network, they just alter the placement of the nodes.
...
For more information about graph layouts...
